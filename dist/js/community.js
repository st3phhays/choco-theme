...
?)|\\$(?!')|<(?!<)|<<str>>)+`.replace(/<<str>>/g, function() {
  ...
  var init_set_cookie_expiration_never = __esm({
    "js/src/util/set-cookie-expiration-never.js"() {
      setCookieExpirationNever = () => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global2, factory) {
          ...
          if (typeof selector === "string") {
            ...
            if (match2 && (match2[1] || !context)) {
              if (match2[1]) {
                ...
                if (rsingleTag.test(match2[1]) && jQuery4.isPlainObject(context)) {
        ...
        jQuery4.fn.extend({
          has: function(target) {
            var targets = jQuery4(target, this), l2 = targets.length;
          ...
          closest: function(selectors, context) {
            var cur, i = 0, l2 = this.length, matched = [], targets = typeof selectors !== "string" && jQuery4(selectors);
        ...
        jQuery4.extend({
          ...
          ajax: function(url, options) {
            ...
            options = options || {};
            var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, completed2, fireGlobals, i, uncached, s2 = jQuery4.ajaxSetup({}, options), callbackContext = s2.context || s2, globalEventContext = s2.context && (callbackContext.nodeType || callbackContext.jquery) ? jQuery4(callbackContext) : jQuery4.event, deferred = jQuery4.Deferred(), completeDeferred = jQuery4.Callbacks("once memory"), statusCode = s2.statusCode || {}, requestHeaders = {}, requestHeadersNames = {}, strAbort = "canceled", jqXHR = {
              readyState: 0,
            ...
            if (s2.data && s2.processData && typeof s2.data !== "string") {
              s2.data = jQuery4.param(s2.data, s2.traditional);
            }
            inspectPrefiltersOrTransports(prefilters, s2, options, jqXHR);
            if (completed2) {
              return jqXHR;
            }
            fireGlobals = jQuery4.event && s2.global;
            ...
            function done(status, nativeStatusText, responses, headers) {
              ...
              if (!isSuccess && jQuery4.inArray("script", s2.dataTypes) > -1 && jQuery4.inArray("json", s2.dataTypes) < 0) {
        ...
        jQuery4.ajaxPrefilter(function(s2) {
          var i;
          for (i in s2.headers) {
        ...
        jQuery4.ajaxPrefilter("script", function(s2) {
          if (s2.cache === void 0) {
            s2.cache = false;
          }
          if (s2.crossDomain) {
        ...
        jQuery4.ajaxTransport("script", function(s2) {
          if (s2.crossDomain || s2.scriptAttrs) {
            var script, callback;
            return {
              send: function(_, complete) {
                script = jQuery4("<script>").attr(s2.scriptAttrs || {}).prop({ charset: s2.scriptCharset, src: s2.url }).on("load error", callback = function(evt) {
                  script.remove();
                  callback = null;
                  if (evt) {
        ...
        jQuery4.ajaxPrefilter("json jsonp", function(s2, originalSettings, jqXHR) {
        ...
        jQuery4.fn.extend({
          ...
          position: function() {
            ...
            return {
              top: offset3.top - parentOffset.top - jQuery4.css(elem, "marginTop", true),
              left: offset3.left - parentOffset.left - jQuery4.css(elem, "marginLeft", true)
            };
          },
...
<p class="mb-0 text-end autocomplete-downloads"><small>${data.value.DownloadCount} downloads</small></p>`;
    ...
    if (carouselH) {
      ...
      const autoplayCarousels = (mediaSm2) => {
        carouselH.forEach((el) => {
          const carouselHCarousel = Carousel.getOrCreateInstance(el, { interval: 2e4 });
          if (mediaSm2.matches) {
  ...
  var selectDeploymentMethodTab = () => {
    const selectedDeploymentMethod = getCookie2("deployment_method") ? document.querySelectorAll(`[data-deployment-method="${getCookie2("deployment_method")}"]`) : document.querySelectorAll('[data-deployment-method="individual"]');
  ...
  (() => {
    if (window.location.pathname.includes("courses")) {
      ...
      const getCourseStorage = () => {
        ...
        for (const i in completed) {
          ...
          for (const completedLink of completedLinks) {
            if (!completedLink.parentNode.classList.contains("active") && !document.querySelector(".course-list").classList.contains("authenticated")) {
      ...
      const installModule = () => {
        ...
        const showInstallMethod = (method2) => {
          document.querySelector(`#${method2}`).style.display = "block";
          document.querySelector(`#${method2}`).classList.add("method");
          document.querySelector(`#${method2}`).scrollIntoView();
        };
        if (method) {
        ...
        const methodSelector = (e) => {
          const method2 = e.target.value.substring(e.target.value.indexOf("#") + 1);
          ...
          window.localStorage.setItem("method", method2);
          window.history.replaceState(null, null, `?method=${method2}`);
          showInstallMethod(method2);
        };
  ...
  (() => {
    (0, import_jquery2.default)(".nav-scrollspy .nav-link").each((index, element) => {
      const scrollHash = (0, import_jquery2.default)(element).attr("href");
      const findActiveRightNavLink = (scrollHash2) => {
        if (scrollHash2 === "#") {
          (0, import_jquery2.default)(element).parent().remove();
          return;
        }
        if (~scrollHash2.indexOf(".")) {
          scrollHash2 = scrollHash2.replace(/\./g, "\\.");
        }
        if ((0, import_jquery2.default)(scrollHash2).length) {
          if ((0, import_jquery2.default)(window).scrollTop() > (0, import_jquery2.default)(scrollHash2).offset().top - 30 && (0, import_jquery2.default)(scrollHash2).is(":visible")) {
            (0, import_jquery2.default)(`a[href="${scrollHash2}"].nav-link`).addClass("active active-page");
            (0, import_jquery2.default)(`a[href="${scrollHash2}"].nav-link`).parent().prev().find("a.active").removeClass("active active-page");
          } else {
            (0, import_jquery2.default)(`a[href="${scrollHash2}"].nav-link`).removeClass("active active-page");
          }
        }
      };
  ...
  (() => {
    (0, import_jquery3.default)(".shuffle").each((index, element) => {
      const divs = (0, import_jquery3.default)(element).children().has("img");
      while (divs.length) {
        (0, import_jquery3.default)(element).prepend(divs.splice(Math.floor(Math.random() * divs.length), 1)[0]);
      }
    });
  })();
